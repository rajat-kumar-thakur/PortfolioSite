...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/rajat-kumar-thakur", handle: "@rajat-kumar-thakur", icon: Github },
  { label: "Twitter", href: "https://x.com/RajatKrThakur04", handle: "@RajatKrThakur04", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/in/rajat-kumar-thakur", handle: "/in/rajat-kumar-thakur", icon: Linkedin },
  { label: "Email", href: "mailto:work.rajatkt@gmail.com", handle: "work.rajatkt@gmail.com", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="pt-2">
              <a
                href="mailto:work.rajatkt@gmail.com"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} Rajat Kumar Thakur — All rights reserved
          </p>
        </div>
      </div>
    </footer>
