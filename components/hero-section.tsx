...
const roles = ["building AI systems", "crafting LLM pipelines", "engineering solutions", "exploring ML models", "creating with code"]
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Rajat Kumar Thakur — Software Engineer
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Software Engineer Intern at <span className="text-foreground font-medium">Cableteque Corporation</span>.
              B.Tech in CSE from IIIT Vadodara (CGPA: 9.46). Passionate about AI/ML, RAG pipelines,
              agentic workflows, and building intelligent systems.
            </p>
