...
const projects = [
  {
    ...
    description:
      "Emotion-aware AI assistant with real-time facial expression detection across 8 emotions using OpenCV. Multimodal pipeline combining voice, vision, and GPT-5 for contextual Hindi conversations with <2s response latency.",
    tags: ["FastAPI", "Next.js", "OpenCV", "LangChain", "LangGraph"],
    status: "shipped",
    year: "2025",
    stars: 0,
    forks: 0,
    url: "https://github.com/rajat-kumar-thakur/hindi-ai-assistant",
    featured: true,
    highlight: true,
  },
  {
    ...
    description:
      "Full-stack PDF Q&A application with RAG pipeline. Implemented semantic chunking (1000+ chunks per document) with Pinecone vector DB, delivering structured answers with citations, reasoning, and confidence metrics in 2.1s.",
    tags: ["FastAPI", "RAG", "Gemini API", "Pinecone", "SQLite"],
    status: "shipped",
    year: "2025",
    stars: 0,
    forks: 0,
    url: "https://github.com/rajat-kumar-thakur/llm-semantic-query",
    featured: true,
  },
  {
    id: 2,
    ...
    description:
      "4x faster pose estimation in point clouds using surface variation and Harris corner detection. Achieved 70% reduction in computation time (26.8s to 7.9s). Paper accepted at PREMI '25 conference.",
    tags: ["Python", "Computer Vision", "Point Clouds", "Research"],
    status: "shipped",
    year: "2025",
    stars: 0,
    forks: 0,
    url: "https://github.com/rajat-kumar-thakur/pose-estimation",
    featured: true,
  },
]
    ...
    <section ref={sectionRef} className="px-4 sm:px-6 py-12 sm:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("mb-12 sm:mb-16 space-y-4 opacity-0", isVisible && "animate-fade-in-up")}>
          <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">Projects</p>
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">Featured Work</h1>
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            AI/ML projects, research work, and full-stack applications. Building intelligent systems with
            modern technologies.
          </p>
        </div>
