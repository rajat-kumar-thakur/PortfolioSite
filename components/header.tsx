...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/rajat-kumar-thakur", icon: Github },
  { label: "Twitter", href: "https://x.com/RajatKrThakur04", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/in/rajat-kumar-thakur", icon: Linkedin },
]
