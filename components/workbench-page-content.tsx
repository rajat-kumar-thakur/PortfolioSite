...
const wipItems = [
  {
    ...
    description: "Scalable search agent using MCP servers achieving 97.6% accuracy",
    progress: 90,
    lastUpdated: "Feb 2026",
    url: "https://github.com/rajat-kumar-thakur/mcp-search-agent",
    branch: "main",
    commits: 67,
  },
  {
    ...
    description: "Production-ready agentic model deployment pipeline",
    progress: 85,
    lastUpdated: "Jan 2026",
    url: "https://github.com/rajat-kumar-thakur/agentic-workflows",
    branch: "develop",
    commits: 45,
  },
  {
    id: 3,
    name: "tinyllama-optimizer",
    description: "Optimized TinyLlama for resource-constrained devices with 46.3% latency reduction",
    progress: 100,
    lastUpdated: "Jul 2025",
    url: "https://github.com/rajat-kumar-thakur/tinyllama-optimizer",
    branch: "main",
    commits: 89,
  },
  {
    id: 4,
    name: "starcoder-inference",
    description: "Fine-tuned StarCoder for code generation with <3s inference",
    progress: 100,
    lastUpdated: "Jul 2025",
    url: "https://github.com/rajat-kumar-thakur/starcoder-inference",
    branch: "main",
    commits: 56,
  },
  {
    ...
    description: "Emotion-aware AI assistant with facial expression detection",
    progress: 95,
...
const recentActivity = [
  { type: "commit", project: "mcp-search-agent", message: "Optimize query performance", time: "2 hours ago" },
  { type: "branch", project: "agentic-workflows", message: "Created feature/deployment branch", time: "5 hours ago" },
  { type: "commit", project: "hindi-ai-assistant", message: "Add emotion detection module", time: "1 day ago" },
  { type: "commit", project: "tinyllama-optimizer", message: "Final optimization pass", time: "2 days ago" },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/rajat-kumar-thakur/active</span>
